  ...
  template: `
    @if (isOpen()) {
      ...
      <div class="hybrid-modal w-full md:max-w-md">
        ...
        <!-- Header -->
        <div class="flex justify-between items-center px-4 pb-4 pt-2 md:pt-4 md:px-5 border-b border-slate-700 bg-slate-800/95 shrink-0 z-10">
        ...
        <!-- Body -->
        <div class="p-4 sm:p-6 space-y-6 flex-1 overflow-y-auto custom-scrollbar">
